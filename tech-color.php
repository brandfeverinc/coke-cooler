...
include_once('inc/classes/Color.php');
include_once('inc/classes/ColorImage.php');
include_once('inc/classes/Technology.php');
include_once('inc/classes/Category.php');

$objColor = new Color();
$oColor = $objColor->getAllColorByCategoryId($_SESSION['sessCategory']);

$objTechnology = new Technology(5);

$objColorImage = new ColorImage();
$oColorImage = $objColorImage->getAllColorImageByColorId($oColor[0]->Id);
...
<body>
	...
	<div class="wrap technology-single">
		...
		<div class="technology-menu left-nav col-sm-3">
			<ul>
				<li>
					<img src="assets/img/tech-color.png" alt="Color">
					<h5>Color</h5>
				</li>
			</ul>
			<ul>
		...
		<div class="col-sm-9 technology-content">
			...
			<div class="overview active-item">
				<div id="tech-single" class="carousel slide" data-ride="carousel">
				  ...
				  <div class="carousel-inner" role="listbox">
				    ...
				    foreach ($oColorImage as $colorimage) {
						...
						echo '    <img class="featured-img" src="/' . $objColorImage->GetPath() . $colorimage->ImageFile . '" />' . PHP_EOL;
					    echo '</div>' . PHP_EOL;
					    $cClass = '';
					}
					?>
				...
				<p class="tech-description"><?php echo $oColor[0]->OverviewText; ?></p>
			</div>
		</div>
	</div>
	<?php 
