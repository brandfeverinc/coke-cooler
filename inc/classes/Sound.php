...
/////////////////////////////////////////////////////////////////////////////
//
// Sound class - represents the sound database table
// Created on: 2016-01-15
/////////////////////////////////////////////////////////////////////////////

require_once("BaseModelPdo.php");

class Sound extends BaseModelPdo
{
    public $Id;
    public $CategoryId;
    public $OverviewText;
    ...
    // Get a list of all Sound items and return as array of objects
    public function getAllSound($orderby = "id")
    {
        // Retrieve all Sound
        $q = "SELECT * FROM sound ORDER BY " . addslashes($orderby);
        $r = parent::returnResultSet($q);
        // Array to hold Sound objects
        $arrSound = array();
        // Create a Sound object for each row and add to array
        foreach ($r as $l) {
            $thisObj = new Sound(
                $l->id,
                $l->category_id,
    ...
    // Get a list of all Sound items by CategoryId and return as array of objects
    public function getAllSoundByCategoryId($category_id = null)
    {
        // Retrieve all Sound By CategoryId
        $q = "SELECT * FROM sound WHERE category_id = ?";
    ...
    {
        $q = "DELETE FROM sound WHERE id = " . intval($deleteID);
        parent::updateQuery($q);
    }
