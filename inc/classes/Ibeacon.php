...
/////////////////////////////////////////////////////////////////////////////
//
// Ibeacon class - represents the ibeacon database table
// Created on: 2016-01-15
/////////////////////////////////////////////////////////////////////////////

require_once("BaseModelPdo.php");

class Ibeacon extends BaseModelPdo
{
    public $Id;
    public $CategoryId;
    public $OverviewText;
    ...
    public function __construct(
        ...
        if (isset($this_id)
            ...
            // Retrieve this row
            $q = "SELECT * FROM ibeacon WHERE id = ?";
            $id = intval($this_id);
    ...
    // Get a list of all Ibeacon items and return as array of objects
    public function getAllIbeacon($orderby = "id")
    {
        // Retrieve all Ibeacon
        $q = "SELECT * FROM ibeacon ORDER BY " . addslashes($orderby);
        $r = parent::returnResultSet($q);
        // Array to hold Ibeacon objects
        $arrIbeacon = array();
        // Create a Ibeacon object for each row and add to array
        foreach ($r as $l) {
            $thisObj = new Ibeacon(
                $l->id,
                $l->category_id,
    ...
    // Get a list of all Ibeacon items by CategoryId and return as array of objects
    public function getAllIbeaconByCategoryId($category_id = null)
    {
        // Retrieve all Ibeacon By CategoryId
        $q = "SELECT * FROM ibeacon WHERE category_id = ?";
    ...
    {
        $q = "DELETE FROM ibeacon WHERE id = " . intval($deleteID);
        parent::updateQuery($q);
    }
