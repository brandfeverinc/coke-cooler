...
?>
	...
	<div id="content">
		...
		<div class="layout">
	        <?php
	        if ($id == 0) {
	            $bread_image_name = 'Sound Add';
	        }
	        else {
	            $bread_image_name = 'Sound Edit';
	        }
			...
			<div class="formstyle ">
				<form method="post" name="admin" id="admin" action="sound_admin.php" enctype='multipart/form-data'>
					...
					<p class="submit"><input type="submit" name="commit" value="Save Sound">&nbsp;&nbsp;<input type="submit" name="commit" value="Cancel"></p>
