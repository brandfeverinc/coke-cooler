...
?>
	...
	<div id="content">
		...
		<div class="layout">
	        <?php
	        if ($id == 0) {
	            $bread_image_name = 'iBeacon Add';
	        }
	        else {
	            $bread_image_name = 'iBeacon Edit';
	        }
			...
			<div class="formstyle ">
				<form method="post" name="admin" id="admin" action="ibeacon_admin.php" enctype='multipart/form-data'>
					...
					<p class="submit"><input type="submit" name="commit" value="Save iBeacon">&nbsp;&nbsp;<input type="submit" name="commit" value="Cancel"></p>
